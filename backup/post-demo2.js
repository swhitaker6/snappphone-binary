...
var startGenTexture = function () {
    ...
    // loader.load('http://dev.sharedocnow.com/images/eagle.png', function(imageBitmap){
        ...
        // var canvasCtx = canvas.msGetInputContext("2d");
        ...
        for(i=0; i < sz; i++) {
          ...
          console.log("WASM module memory contents after Module.HEAP8.set() call");

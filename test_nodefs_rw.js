...
var wasmBinaryFile;
  wasmBinaryFile = 'test_nodefs_rw.wasm';
...
var ASM_CONSTS = {
  1896: () => { var fs = require('fs'); fs.writeFileSync('foobar.txt', 'yeehaw'); },  
 1962: () => { FS.mkdir('/working'); FS.mount(NODEFS, { root: '.' }, '/working'); },  
 2029: () => { var fs = require('fs'); var contents = fs.readFileSync('foobar.txt', { encoding: 'utf8' }); assert(contents === 'cheez'); }
};
